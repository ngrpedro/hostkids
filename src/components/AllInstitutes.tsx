...
const AllInstitutes = () => {
  ...
  return (
    <div className="flex gap-5 flex-wrap ms:p-4 h-[38rem] m-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 max-w-[680px]">
      {institutes.map((item, index) => {
        const { name, adress } = item;
        return (
          <div
            key={index}
            className="border border-gray-900 rounded-md m-auto md:m-0 w-64 sm:w-72"
          >
